...
class PurchaseProject(RelTable):
    ...
    ProjectCode = Column(String(128), comment='项目编号')
    ...
    ProjectDirectoryName = Column(String(400), comment='项目采购目录名称')
    ProjectDirectoryCode = Column(String(200), comment='项目采购目录编码')
