from sqlalchemy import CHAR, Column, DECIMAL, DateTime, String
...
class PurchaseProvider(RelTable):
    __tablename__ = 'purchase_provider'
    ...
    MainScope = Column(LONGTEXT, comment='经营范围（主营）')
    ...
    EnterpriseScale = Column(INTEGER(11), comment='企业规模1-大型2-中型3-小型4-微型5-不划型')
    OperAccount = Column(String(200), comment='开户行')
    Accounts = Column(String(200), comment='帐号')
    EconSectorId = Column(LONGTEXT, comment='所属经济行业标识')
    EconSectorName = Column(LONGTEXT, comment='所属经济行业')
