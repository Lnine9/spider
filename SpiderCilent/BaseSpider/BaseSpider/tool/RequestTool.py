import requests
from BaseSpider.base_component.annoucement_request_resolver.GGZY_Annoucement import GGZY_Announce_Req_Resolver
...
class HttpSession(object):
    ...
    def request(self, url, data=None, headers=None):
        ...
        # return self.session.post(url=r'http://172.26.52.92:8899/databaseOperate/'+url, data=data, headers=headers)
