...
class GZ_SJ_County_Failure_Html(HtmlPageResolver):
    ...
    def resolver_page(self) -> dict:
        ...
        agency = ''
        if self.response.xpath('//*[@id="info"]/ul/li[4]').get() is not None:
            agency = self.response.xpath('//*[@id="info"]/ul/li[4]').get()
        else:
            agency = '无'
        ...
        code_dict = {'code': ''.join(self.response.xpath('//*[@id="info"]').extract()),
        ...
        return {'FB_G': content, 'code_dict': code_dict, 'at_dict': at_dict}
    ...
    def get_projec_name(self):
        project_name = self.response.xpath('//*[@id="info"]/ul/li[2]/text()').get()
    ...
    def get_poj_code(self):
        poj_code = self.response.xpath('//*[@id="info"]/ul/li[1]/text()').get()
    ...
    def get_poj_rel(self):
        ...
        if '联系人' in self.response.xpath('//*[@id="info"]/ul[1]/li[12]').get():
            poj_rel = self.response.xpath('//*[@id="info"]/ul[1]/li[12]').get()
        elif '联系人' in self.response.xpath('//*[@id="info"]/ul[1]/li[11]').get():
            poj_rel = self.response.xpath('//*[@id="info"]/ul[1]/li[11]').get()
    ...
    def get_kai_time(self):
        kai_time = self.response.xpath('//*[@id="info"]/ul/li[6]/text()').get()
    ...
    # 获得采购机构
    def get_unit(self):
        unit = self.response.xpath('//*[@id="info"]/ul/li[3]/text()').get()
    ...
    def get_call_way(self):
        cal_way = self.response.xpath('//*[@id="info"]/ul/li[5]/text()').get()
    ...
    def get_failure_content(self):
        reason = ''
        if '原因' in self.response.xpath('//*[@id="info"]/ul/li[11]/text()').get():
            reason = self.response.xpath('//*[@id="info"]/ul/li[11]/text()').get()
        elif '原因' in self.response.xpath('//*[@id="info"]/ul/li[10]/text()').get():
            reason = self.response.xpath('//*[@id="info"]/ul/li[10]/text()').get()
    ...
    def get_agency(self):
        ...
        agency = self.response.xpath('//*[@id="info"]/ul[1]/li[4]').get()
    ...
    def get_agent_name(self):
        agent_name = ''.join(self.response.xpath('//*[@id="info"]/ul/li[4]/text()[1]').extract()).split('：')
    ...
    def get_agent_address(self):
        ...
        address = ''.join(self.response.xpath('//*[@id="info"]/ul/li[4]/text()[2]').extract())
