...
class GZ_SJ_County_Modify_Html(HtmlPageResolver):

    def resolver_page(self) -> dict:

        agent = ''
        if self.response.xpath(CONST_PARAM.get('Agent')).get() is not None:
            agent = self.response.xpath(CONST_PARAM.get('Agent')).get()
        elif self.response.xpath('//*[@id="info"]/ul/li[13]/ul/li[2]/text()').get() is not None:
            agent = self.response.xpath('//*[@id="info"]/ul/li[13]/ul/li[2]/text()').get()

        agency = ''
        if self.response.xpath(CONST_PARAM.get('Agent_re')).get() is not None:
            agency = self.response.xpath(CONST_PARAM.get('Agent_re')).get()
        elif self.response.xpath('//*[@id="info"]/ul/li[13]/ul/li[3]/text()').get() is not None:
            agency = self.response.xpath('//*[@id="info"]/ul/li[13]/ul/li[3]/text()').get()
        ...
        return {'MB_G': content, 'code_dict': code_dict, 'at_dict': at_dict, 'result': [], 'code': 'true'}
    ...
    def get_poj_code(self):
        poj_code = self.response.xpath('//*[@id="info"]/ul/li[4]').get()
    ...
    def get_agent_name(self):
        name = ''
        if self.response.xpath('//*[@id="info"]/ul/li[14]').get() is not None and '代理机构' in self.response.xpath('//*[@id="info"]/ul/li[14]').get():
            name = self.response.xpath('//*[@id="info"]/ul/li[14]/text()[2]').get()
            name = name.strip()
        elif self.response.xpath('//*[@id="info"]/ul/li[13]').get() is not None and '代理机构' in self.response.xpath('//*[@id="info"]/ul/li[13]').get():
            name = self.response.xpath('//*[@id="info"]/ul/li[13]/text()[2]').get()
            name = name.strip()
    ...
    def get_agent_address(self):
        address = ''
        if self.response.xpath('//*[@id="info"]/ul/li[14]').get() is not None and '代理机构' in self.response.xpath('//*[@id="info"]/ul/li[14]').get():
            address = ''.join(self.response.xpath('//*[@id="info"]/ul/li[14]/ul/li[1]/text()').extract())
        elif self.response.xpath('//*[@id="info"]/ul/li[13]').get() is not None and '代理机构' in self.response.xpath('//*[@id="info"]/ul/li[13]').get():
            address = ''.join(self.response.xpath('//*[@id="info"]/ul/li[13]/ul/li[1]/text()').extract())
    ...
    def get_poj_rel(self):
        poj_rel = self.response.xpath('//*[@id="info"]/ul[1]/li[6]').get()
    ...
    def get_rel_num(self):
        poj_rel_num = self.response.xpath('//*[@id="info"]/ul[1]/li[7]').get()
    ...
    def get_unit(self):
        unit = ''
        if '采购人名称' in self.response.xpath('//*[@id="info"]/ul[1]/li[13]/span/text()').get():
            unit = self.response.xpath('//*[@id="info"]/ul[1]/li[13]').get()
        elif '采购人名称' in self.response.xpath('//*[@id="info"]/ul[1]/li[12]/span/text()').get():
            unit = self.response.xpath('//*[@id="info"]/ul[1]/li[12]').get()
    ...
    def get_call_way(self):
        cal_way = self.response.xpath('//*[@id="info"]/ul[1]/li[8]').get()
    ...
    def get_open_time(self):
        open_time = self.response.xpath('//*[@id="info"]/ul[1]/li[9]').get()
    ...
    def get_modify_content(self):
        modify_content = self.response.xpath('//*[@id="info"]/ul[1]/li[10]').get()
    ...
    def get_agency(self):
        agency=''
        if self.response.xpath('//*[@id="info"]/ul[1]/li[14]/span/text()').get() is not None and '采购代理机构' in self.response.xpath('//*[@id="info"]/ul[1]/li[14]/span/text()').get():
            agency = self.response.xpath('//*[@id="info"]/ul[1]/li[14]').get()
        elif '采购代理机构' in self.response.xpath('//*[@id="info"]/ul[1]/li[13]/span/text()').get():
            agency = self.response.xpath('//*[@id="info"]/ul[1]/li[13]').get()
