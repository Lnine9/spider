...
class XNYY(HtmlPageResolver):
    ...
    def getCodeHtml(self):
        ...
        code_dict['code'] = self.resp.xpath("//form[@name='_newscontent_fromname']").get()
    ...
    def getCBContent(self):
        ...
        content['proj_item'] = ''
        content['ancm_time'] = get_one_time_from_str(resp.xpath(".//div[@class='Author']/span[1]/text()").extract_first())
