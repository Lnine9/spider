...
from BaseSpider.base_component.utils.util import k_remove
...
class YNPR_ResultBid_sub_component1(SubResolver):
    ...
    def getResultsBidEngineering(self):
        ...
        for each in self.response_text.xpath('/html/body/div[5]/div/div/div/div/table/tr'):
        ...
        content['ancm_time'] = (re.findall(r"发布时间(.*)", self.response_text.xpath('/html/body/div[5]/div/p/text()').get()))[0]
        content['sourse_url'] = self.response_url
        content['opening_time'] = None
        content['proj_unit_address'] = None
        content['agent_unit_address'] = None
        content['proj_unit'] = None
        return content
    ...
    def getWbSupplier(self):
        ...
        item = {}
        item['supp_name'] = content['中标人']
        item['supp_code'] = content['中标人代码']
        item['supp_ranking'] = '1'
        item['supp_amount'] = content['中标价（费率或单价等）']
        wb_supp.append(item)
        return wb_supp
