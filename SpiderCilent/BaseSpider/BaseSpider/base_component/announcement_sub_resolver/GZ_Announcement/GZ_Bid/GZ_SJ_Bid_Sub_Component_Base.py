...
class GZ_SJ_Bid_Sub_Component_Base(SubResolver):
    def resolver_page(self) -> dict:
        # print('中标供应商')
        # print(self.response_text.xpath('//*[@id="tabrow"]').get())
        # print('代理机构和联系方式')
        # print(self.response_text.xpath(CONST_PARAM.get('Agent')).get() + ' ' +self.response_text.xpath(CONST_PARAM.get('Agent_re')).get())
        # print('代理机构收费标准')
        # print()
        # 代理机构收费标准
        charge_standard = ''
        if self.response_text.xpath('//*[@id="info"]/ul/li[18]/ul/li[1]/text()').get() is not None:
            charge_standard = self.response_text.xpath('//*[@id="info"]/ul/li[18]/ul/li[1]/text()').get().strip()
        else:
            charge_standard = '无'

        charge_amount = ''
        if self.response_text.xpath('//*[@id="info"]/ul/li[18]/ul/li[2]/text()').get() is not None:
            charge_amount = self.response_text.xpath('//*[@id="info"]/ul/li[18]/ul/li[2]/text()').get().strip()
        else:
            charge_amount = '无'

        # print('代理机构收费金额')
        # print(self.response_text.xpath('//*[@id="info"]/ul/li[18]/ul/li[2]/text()').get())
        # print('中标金额')
        # print(self.response_text.xpath('//*[@id="turnoverAmount"]/text()').get())
        ...
        content = {'公告标题': self.getTitle(),
                   ...
                   '代理机构联系方式': self.response_text.xpath(CONST_PARAM.get('Agent_re')).get(),
                   '采购方式': self.get_call_way(),
                   '开标时间': self.get_open_time(),
                   '公告网页URL': self.get_url(),
                   '中标供应商': ''.join(self.response_text.xpath('//*[@id="info"]/ul/li[14]/ul').extract()),
    ...
    def get_poj_code(self):
        poj_code = self.response_text.xpath('//*[@id="info"]/ul[1]/li[2]').get()
    ...
    def get_poj_rel(self):
        poj_rel = self.response_text.xpath('//*[@id="info"]/ul[1]/li[4]').get()
    ...
    def get_rel_num(self):
        poj_rel_num = self.response_text.xpath('//*[@id="info"]/ul[1]/li[5]').get()
    ...
    def get_unit(self):
        unit = ''
        # if '采购人名称' in self.response_text.xpath('//*[@id="info"]/ul[1]/li[15]/span/text()').get():
        #     unit = self.response_text.xpath('//*[@id="info"]/ul[1]/li[15]').get()
        # elif '采购人名称' in self.response_text.xpath('//*[@id="info"]/ul[1]/li[14]/span/text()').get():
        #     unit = self.response_text.xpath('//*[@id="info"]/ul[1]/li[14]').get()

        unit = self.response_text.xpath('//*[@id="info"]/ul/li[16]').get()
    ...
    def get_agent_name(self):
        ...
        if '代理机构' in self.response_text.xpath('//*[@id="info"]/ul/li[17]').get():
            agent_name = self.response_text.xpath('//*[@id="info"]/ul/li[17]').get()
        elif '代理机构' in self.response_text.xpath('//*[@id="info"]/ul/li[16]').get():
            agent_name = self.response_text.xpath('//*[@id="info"]/ul/li[16]').get()
    ...
    def get_agent_address(self):
        ...
        if '代理机构' in self.response_text.xpath('//*[@id="info"]/ul/li[17]').get():
            address = self.response_text.xpath('//*[@id="info"]/ul/li[17]/ul/li[1]').get()
        elif '代理机构' in self.response_text.xpath('//*[@id="info"]/ul/li[16]').get():
            address = self.response_text.xpath('//*[@id="info"]/ul/li[16]/ul/li[1]').get()
    ...
    def get_unit_address(self):
        address = self.response_text.xpath('//*[@id="purchasingContact"]/li[1]').get()
    ...
    def get_call_way(self):
        cal_way = self.response_text.xpath('//*[@id="info"]/ul[1]/li[7]').get()
    ...
    def get_judge_time(self):
        judge_time = self.response_text.xpath('//*[@id="info"]/ul[1]/li[10]').get()
    ...
    def get_judge_are(self):
        judge_are = self.response_text.xpath('//*[@id="info"]/ul[1]/li[11]').get()
    ...
    def get_open_time(self):
        open_time = self.response_text.xpath('//*[@id="info"]/ul[1]/li[13]').get()
    ...
    def get_end_time(self):
        end_time = self.response_text.xpath('//*[@id="info"]/ul[1]/li[10]').get()
    ...
    def get_open_area(self):
        open_area = self.response_text.xpath('//*[@id="info"]/ul[1]/li[12]').get()
    ...
    def get_agency(self):
        agency=''
        if self.response_text.xpath('//*[@id="info"]/ul[1]/li[17]/span/text()').get() is not None and '采购代理机构' in self.response_text.xpath('//*[@id="info"]/ul[1]/li[17]/span/text()').get():
            agency = self.response_text.xpath('//*[@id="info"]/ul[1]/li[17]').get()
        elif '采购代理机构' in self.response_text.xpath('//*[@id="info"]/ul[1]/li[16]/span/text()').get():
            agency = self.response_text.xpath('//*[@id="info"]/ul[1]/li[16]').get()
    ...
    # 获得标书发售开始和截止时间
    def get_times(self):
        times = self.response_text.xpath(CONST_PARAM.get('saleTime')).get().split(':', 1)
    ...
    # 获得标书价格
    def get_price(self):
        prices = self.response_text.xpath(CONST_PARAM.get('price')).get().split(':')
        price = prices[1]
    ...
    # 获得精准区域
    def get_area(self):
        area = self.response_text.xpath('//*[@id="purchasingContact"]/li[1]/text()').get().strip()
        area = '贵州省' + area
