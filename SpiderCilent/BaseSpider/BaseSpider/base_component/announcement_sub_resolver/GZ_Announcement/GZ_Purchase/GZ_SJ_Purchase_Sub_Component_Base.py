...
class GZ_SJ_Purchase_Sub_Component_Base(SubResolver):
    def resolver_page(self) -> dict:
        ...
        content = {'公告标题': self.getTitle(),
                   ...
                   '代理机构名称': self.response_text.xpath(CONST_PARAM.get('Agent')).get(),
                   '代理机构地址': self.response_text.xpath('//div[@id="info"]/ul/ul[6]/li[1]/text()').get(),
    ...
    def get_call_way(self):
        cal_way = self.response_text.xpath('//*[@id="info"]/ul[1]/li[6]').get()
    ...
    def get_open_time(self):
        open_time = self.response_text.xpath('//*[@id="info"]/ul[1]/li[11]').get()
    ...
    # 获得精准区域
    def get_area(self):
        area = self.response_text.xpath('//*[@id="info"]/ul/ul[5]/li[1]/text()').get().strip()
        area = '贵州省' + area
