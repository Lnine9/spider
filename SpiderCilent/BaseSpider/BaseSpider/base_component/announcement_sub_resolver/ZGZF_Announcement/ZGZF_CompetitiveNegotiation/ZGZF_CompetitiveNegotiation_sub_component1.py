...
class ZGZF_Announce_Resolver_CompetitiveNegotiation_component1(SubResolver):
    def __init__(self):
        self.all_item = {}
    ...
    def getInquiryGovernment(self):
        ...
        # print(self.response_url, all_item)
        ...
        # 其它补充事宜
        other_info = search_all_by_xpath('其它补充事宜', '项目联系方式', response, 'p', '', 2)
