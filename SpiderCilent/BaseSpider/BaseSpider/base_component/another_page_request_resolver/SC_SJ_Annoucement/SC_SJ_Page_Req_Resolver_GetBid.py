...
class SC_SJ_Page_Req_Resolver_GetBid(RequestResolver):
    """翻页请求解析器"""
    """
    允许自定义代码
    """
    ...
    def general_param(self) -> dict:
        ...
        # 以下为自定义代码
        gen_param = {}
        url = 'http://www.ccgp-sichuan.gov.cn/CmsNewsController.do?method=recommendBulletinList&moreType=provincebuyBulletinMore&channelCode=jggg&rp=25&page={pageindex}'.format(pageindex= self.page_num)
        body = {}
