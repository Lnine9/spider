...
class SC_SJ_Page_Req_Resolver_FailureBid(RequestResolver):
    """翻页请求解析器"""
    ...
    def general_param(self) -> dict:
        ...
        # 以下为自定义代码
        gen_param = {}
        url = 'http://www.ccgp-sichuan.gov.cn/CmsNewsController.do?method=recommendBulletinList&rp=25&page={pageindex}&moreType=provincebuyBulletinMore&channelCode=fblbgg'.format(pageindex = self.page_num)
        body = {}
