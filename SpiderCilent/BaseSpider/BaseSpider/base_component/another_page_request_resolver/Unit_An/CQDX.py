...
class CQDX(RequestResolver):
    ...
    def general_param(self) -> dict:
        ...
        body = 't_='+str(random())+'&window_=json&start='+str((self.page_num-1)*25+1)+'&limit=25&filter=&sort=beginTime%20desc&type=ZCXQ&type' \
               '=YQXQ&type=CSXQ&isEnd=&catalog=A&shopType=&notShopType=DYLY&categoryId=101720&keywords=&request_method_=ajax&browser_=notmsie&page=cms.psms.publish.query'
