...
from BaseSpider.base_component.annoucement_request_resolver.ZGZF_H_Annoucement.ZGZF_Annouce_Req_Tenders_Resolver import ZGZF_START_TIME,ZGZF_END_TIME


class ZGZF_Page_Req_Resolver_Tenders(RequestResolver):
    """
    允许自定义代码
    """
