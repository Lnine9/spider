...
from BaseSpider.base_component.annoucement_request_resolver.ZGZF_H_Annoucement.ZGZF_Annouce_Req_Source_Resolver import ZGZF_START_TIME,ZGZF_END_TIME


class ZGZF_Page_Req_Resolver_Source(RequestResolver):
    """
    允许自定义代码
    """
    ...
    def general_param(self) -> dict:
        ...
        body = 'searchtype=1&bidType=4&page_index={index}&timeType=6'.format(index=page_number)
