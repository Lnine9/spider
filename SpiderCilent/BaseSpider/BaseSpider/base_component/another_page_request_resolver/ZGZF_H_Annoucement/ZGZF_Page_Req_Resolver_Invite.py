...
from BaseSpider.base_component.annoucement_request_resolver.ZGZF_H_Annoucement.ZGZF_Annouce_Req_Invite_Resolver import ZGZF_START_TIME,ZGZF_END_TIME


class ZGZF_Page_Req_Resolver_Invite(RequestResolver):
    """
    允许自定义代码
    """
    ...
    def general_param(self) -> dict:
        ...
        body = 'searchtype=1&bidType=6&page_index={index}&timeType=6'.format(index=page_number)
