...
class GZ_XJ_Annouce_Purchase_Page(RequestResolver):
    ...
    def general_param(self) -> dict:
        ...
        body = 'siteId=1&articlePageNo=' + str(self.req_attr.page_num) + '&category.id=1153797950913584&articlePageSize=15',
