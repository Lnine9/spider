...
class GZ_SJ_County_Purchase_Page(RequestResolver):
    ...
    def general_param(self) -> dict:
        ...
        body = 'siteId=1&articlePageNo=' + str(self.req_attr.page_num) + '&category.id=1153418052184995&articlePageSize=15',
