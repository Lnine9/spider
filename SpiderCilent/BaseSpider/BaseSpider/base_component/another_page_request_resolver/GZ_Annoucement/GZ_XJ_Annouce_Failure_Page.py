...
class GZ_XJ_Annouce_Failure_Page(RequestResolver):
    ...
    def general_param(self) -> dict:
        ...
        body = 'siteId=1&articlePageNo=' + str(self.req_attr.page_num) + '&category.id=1153845808113747&articlePageSize=15',
