...
class HN2_Intention(RequestResolver):
    """
    允许自定义代码
    """
    ...
    def general_param(self) -> dict:
        ...
        # 以下为自定义代码
        gen_param = {}
        url = 'http://www.ccgp-hunan.gov.cn/mvc/getnewCityContentList.do'
        body = 'column_code=51%2C52&title=&dept=&pub_time1=&pub_time2=&county=&area_id=1&page={num}&pageSize=18'.format(
            num=self.page_num)
